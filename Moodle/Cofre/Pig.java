...
public class Pig 
{
    ...
    public String toString()
    {
        ...
        return "["+toStringArrayCoin(coins)+toStringArrayItem(items)+"] : " + new DecimalFormat("#0.00", new DecimalFormatSymbols(Locale.US)).format(getValue()) +
        "$ : " + getVolume() + "/" + volumeMax + state;
    }
